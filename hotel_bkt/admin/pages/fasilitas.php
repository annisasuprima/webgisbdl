<div class="col-sm-12">  <!-- menampilkan fasilitas-->
    <section class="panel">
        <div class="panel-body">
            <a href="?page=fasilitas_add" class="btn btn-compose" title="Add Facility"  style="background-color:black;border-bottom:black;color:white;"><i class="fa fa-plus"></i>Facility</a>
            <div class="box-body">
