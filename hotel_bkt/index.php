  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg" style="background-color:black;border-bottom:1px solid black;">
        ...
        <!--logo start-->
        <a href="index.php" class="logo" style="color:white;"><b>WebGis Hotel (11 1811521015 Annisa Suprima )</b></a>
        <div class="top-menu">
      ...
      *********************************************************************************************************************************************************** -->                  
             ...
             <div id="view_kanan_table" class="col-md-4 col-sm-4 mb" style="margin-top:20px; display:block;"> 
                        ...
                        <div id="populerhotel">
                          <div class="container2">
                            ...
                            <div class="mySlides">
                                ...
                                <a href="" onclick="galleryreco('H046')"><img src="../_foto/H0461.jpg" style="width:100%"></a>
                                <div style="background-color: black"><label style="color:white">Hotel Grand Rocky</label></div>
                               
                              </div>

                              <div class="mySlides">
                              
                                <a href="" onclick="galleryreco('H016')"><img src="../_foto/H0161.jpg" style="width:100%"></a>
                                <div style="background-color: black"><label style="color:white">Hotel Grand Royal Denai</label></div>
                               
                              </div>

                              <div class="mySlides">
                             
                                <a href="" onclick="galleryreco('H030')"><img src="../_foto/H0301.jpg" style="width:100%"></a>
                                <div style="background-color: black"><label style="color:white">Novotel</label></div>
                               
                              </div>
                                
                              <div class="mySlides">
                              
                                <a href="" onclick="galleryreco('H006')"><img src="../_foto/H0061.jpg" style="width:100%"></a>
                                <div style="background-color: black"><label style="color:white">Campago Resort Hotel </label></div>
                            ...
                            <div class="row2">
                              <div class="column">
                                <img class="demo cursor" src="../_foto/H0461.jpg" style="width:100%" onclick="currentSlide(1)">
                              </div>
                              <div class="column">
                                <img class="demo cursor" src="../_foto/H0161.jpg" style="width:100%" onclick="currentSlide(2)">
                              </div>
                              <div class="column">
                                <img class="demo cursor" src="../_foto/H0301.jpg" style="width:100%" onclick="currentSlide(3)">
                              </div>
                              <div class="column">
                                <img class="demo cursor" src="../_foto/H0061.jpg" style="width:100%" onclick="currentSlide(4)">
                              </div>
                      ...
                      <div id="view_kanan_table1" class="col-md-4 col-sm-4 mb" style="margin-top:0px; display:none;">
                        <div class="white-panel pns">
                           <div class="white-header" style="height:40px;margin:20px;background-color:white;color:black">
