...
<div class="col-sm-12">  <!-- menampilkan list mosque-->
    <section class="panel">
        <div class="panel-body">
            <a href="?page=hotel_add" title="Add Hotel" class="btn btn-compose" style="background-color:black;border-bottom:black;color:white;"><i class="fa fa-plus"></i>Add Hotel</a>
            <div class="box-body">
