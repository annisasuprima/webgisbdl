    ...
    <section class="panel">
        <div class="panel-body">
           <!--  <?php 
            ...
            ?> -->
            <a href="?page=user_add" class="btn btn-compose" title="Add User"  style='background-color:black;border-bottom:black;color:white;'><i class="fa fa-plus"></i>Add User</a>
            <div class="box-body">
