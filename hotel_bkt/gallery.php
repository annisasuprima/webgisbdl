                      ...
                      <section class="panel">
                          <div class="panel-body">
                             ...
                             <div style="overflow-y: auto; overflow-x:auto; margin:15px; display:flex; justify-content:center">
                              <div class="html5gallery" style="max-height:700px; overflow:auto; display:block;" data-skin="horizontal" data-width="470" data-height="300" data-resizemode="fit"><?php
                    ...
                    <div class="col-sm-12"> <!-- peta -->
                      <div class="white-panel pns">
                                ...
                                <header class="panel-heading" style="float:left">
                                  ...
                                  <label id="tombol"><a class="btn btn-success" role="button" id="showlegenda" data-toggle="collapse" onclick="legenda()" title="Legend" style="margin-right:10px"><i class="fa fa-eye" style="color: white;"></i></a></label>
