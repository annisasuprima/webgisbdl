      ...
      *********************************************************************************************************************************************************** -->
      ...
      <div class="container">
          ...
          <form class="form-login" action="../act/regis.php" method="POST" role="form">
            <h2 class="form-login-heading"  style='background-color:black;border-bottom:black;color:white;'>REGISTRATION</h2>
            <div class="login-wrap">
                    ...
                    <br>
                    <button class="btn btn-theme btn-block" name="regis" type="submit"  style='background-color:black;border-bottom:black;color:white;'><i class="fa fa-lock"></i> SIGN UP</button>          
            </div>
          </form>     
      </div>
    </div>    
